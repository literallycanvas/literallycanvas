...
(function() {
    ...
    LC.LiterallyCanvas = function() {
        ...
        LiterallyCanvas.prototype.setBackgroundColor = function(color) {
...
(function() {
    ...
    LC.Toolbar = function() {
        ...
        Toolbar.prototype.initColors = function() {
            var $bgPicker, $stroke, cp, _this = this;
            ...
            this.lc.on("colorChange", function(color) {
                return $stroke.css("background-color", color);
            });
            $bgPicker = $(".bg-picker");
            $bgPicker.css("background-color", this.lc.backgroundColor);
            return LC.makeColorPicker($bgPicker, "Background color", function(c) {
                var val;
                val = "rgba(" + c.r + ", " + c.g + ", " + c.b + ", 1)";
                $bgPicker.css("background-color", val);
                return _this.lc.setBackgroundColor(val);
            });
        };
