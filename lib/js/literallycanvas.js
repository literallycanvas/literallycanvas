...
(function() {
    ...
    LC.Toolbar = function() {
        ...
        Toolbar.prototype.initColors = function() {
            var $bgPicker, $stroke, cp1, cp2, _this = this;
            $stroke = this.$el.find(".stroke-picker");
            $stroke.css("background-color", this.lc.getColor("primary"));
            cp1 = LC.makeColorPicker($stroke, "Foreground color", function(c) {
                return _this.lc.setColor("primary", "rgba(" + c.r + ", " + c.g + ", " + c.b + ", 1)");
            });
            this.lc.on("primaryColorChange", function(color) {
                return $stroke.css("background-color", color);
            });
            $bgPicker = $(".bg-picker");
            $bgPicker.css("background-color", this.lc.getColor("background"));
            cp2 = LC.makeColorPicker($bgPicker, "Background color", function(c) {
                return _this.lc.setColor("background", "rgba(" + c.r + ", " + c.g + ", " + c.b + ", 1)");
            });
            this.lc.on("backgroundColorChange", function(color) {
                return $bgPicker.css("background-color", color);
            });
...
(function() {
    ...
    LC.RectangleTool = function(_super) {
        ...
        RectangleTool.prototype.begin = function(x, y, lc) {
            return this.currentShape = new LC.Rectangle(x, y, this.strokeWidth, lc.getColor("primary"));
        };
