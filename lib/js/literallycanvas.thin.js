...
(function() {
    ...
    refine = function(points) {
        var refined;
        points = points.concat(_.last(points));
        refined = [];
...
(function() {
    ...
    LC.LinePathShape = function() {
        function LinePathShape(tool) {
            ...
            this.tailSize = 3;
            this.sampleSize = this.sampleSize + 1;
        }
        LinePathShape.prototype.addPoint = function(x, y) {
            ...
            if (!this.smoothedPoints || this.points.length < this.sampleSize) {
                this.smoothedPoints = [ this.points[0] ].concat(LC.bspline(this.points, this.order));
            } else {
                this.tail = _.last(LC.bspline(_.last(this.points, this.sampleSize), this.order), this.segmentSize * this.tailSize);
                this.smoothedPoints = _.initial(this.smoothedPoints, this.segmentSize * (this.tailSize - 1)).concat(this.tail);
            }
            return this.tail = void 0;
        };
