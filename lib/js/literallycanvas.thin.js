...
(function() {
    ...
    LC.Pencil = function(_super) {
        ...
        Pencil.prototype.optionsContents = function() {
            ...
            $el = $("      <div>        <span class='brush-width-min'>1 px</span>        <input type='range' min='1' max='50' step='1' value='" + this.strokeWidth + "'>        <span class='brush-width-max'>50 px</span>        <span class='brush-width-val'>(5 px)</span>        </input>    ");
