    ...
    LC.LinePathShape = function() {
        ...
        LinePathShape.prototype.addPoint = function(x, y) {
            ...
            if (!this.smoothedPoints || this.points.length < this.tailSize) {
                return this.smoothedPoints = [ this.points[0] ].concat(LC.bspline(this.points, this.order));
            } else {
                this.tail = _.last(LC.bspline(_.last(this.points, this.tailSize), this.order), Math.pow(2, this.order) + 1);
