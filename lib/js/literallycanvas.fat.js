...
(function() {
    ...
    LC.ColorPicker = function() {
        function ColorPicker(width, height) {
            this.width = width;
            this.height = height;
            this.wheel = this.createWheel();
            this.picker = $("<canvas>").mousemove(function(e) {
                var ctx;
        ...
        ColorPicker.prototype.createWheel = function() {
            var ctx, wheel;
            wheel = $("<canvas>").attr({
                width: this.width,
                height: this.height
            ...
            ctx.beginPath();
            ctx.moveTo(0, 0);
            ctx.lineTo(wheel.width, wheel.height);
            ctx.stroke();
            return wheel;
        };
        return ColorPicker;
...
(function() {
    ...
    LC.LinePathShape = function() {
        ...
        LinePathShape.prototype.update = function(ctx) {
