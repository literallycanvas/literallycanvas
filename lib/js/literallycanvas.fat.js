...
(function() {
    var IS_IOS, buttonIsDown, coordsForTouchEvent, initLiterallyCanvas, position, _ref;
    window.LC = (_ref = window.LC) != null ? _ref : {};
    ...
    $.fn.literallycanvas = function(opts) {
        ...
        if (IS_IOS) {
            this.bind("touchstart", function(e) {
                ...
                t2 = e.timeStamp;
                t1 = _this.data("lastTouch") || t2;
                dt = t2 - t1;
                fingers = e.originalEvent.touches.length;
                _this.data("lastTouch", t2);
                if (!dt || dt > 500 || fingers > 1) {
                    return;
                }
                e.preventDefault();
                return _this.trigger("click").trigger("click");
            });
        }
