    ...
    LC.LiterallyCanvas = function() {
        ...
        LiterallyCanvas.prototype.update = function(shape) {
            if (shape.tail) {
                ...
                shape.drawTail(this.ctx);
                return this.ctx.restore();
            } else {
                this.repaint(false);
                return this.draw([ shape ], this.ctx);
            }
        };
        ...
        LiterallyCanvas.prototype.uploadToImgur = function(opts) {
            var d, img;
            opts = _.extend({
                name: "drawing.png",
                title: "A Drawing",
        ...
        LiterallyCanvas.prototype.imageURL = function() {
            this.repaint(true, true);
...
(function() {
    var IS_IOS, buttonIsDown, coordsForEvent, initLiterallyCanvas, position, _ref;
    window.LC = (_ref = window.LC) != null ? _ref : {};
    ...
    initLiterallyCanvas = function(el, opts) {
        var $c, $el, $tbEl, down, lc, resize, tb, _this = this;
        if (opts == null) opts = {};
        opts = _.extend({
    ...
    $.fn.uploadCanvasToImgur = function(opts) {
        if (opts == null) opts = {};
        return this.get(0).literallycanvas.uploadToImgur(opts);
    };
    $.fn.canvasImageURL = function() {
        return this.get(0).literallycanvas.imageURL();
    };
}).call(this);
...
(function() {
    ...
    LC.LinePathShape = function() {
        ...
        LinePathShape.prototype.addPoint = function(x, y) {
            var newPoint;
            newPoint = this.tool.makePoint(x, y);
            this.points.push(newPoint);
            if (!this.smoothedPoints || this.points.length < this.tailSize) {
                return this.smoothedPoints = LC.bspline(this.points, this.order);
            } else {
                this.tail = [ _.last(this.smoothedPoints) ].concat(_.last(LC.bspline(_.last(this.points, this.tailSize), this.order), Math.pow(2, this.order)));
                return this.smoothedPoints = this.smoothedPoints.concat(_.rest(this.tail));
            }
        };
        ...
        LinePathShape.prototype.drawTail = function(ctx) {
            return this.draw(ctx, this.tail);
        };
...
(function() {
    ...
    LC.Pencil = function(_super) {
        ...
        Pencil.prototype.buttonContents = function() {
            return '<img src="lib/img/pencil.png">';
        };
        ...
        Pencil.prototype.drawCurrent = function(ctx) {
            if (this.currentShape) return this.currentShape.draw(ctx);
        };
    ...
    LC.Eraser = function(_super) {
        ...
        Eraser.prototype.buttonContents = function() {
            return '<img src="lib/img/eraser.png">';
        };
    ...
    LC.Pan = function(_super) {
        ...
        Pan.prototype.buttonContents = function() {
            return '<img src="lib/img/pan.png">';
        };
    ...
    LC.EyeDropper = function(_super) {
        ...
        EyeDropper.prototype.buttonContents = function() {
            return '<img src="lib/img/eyedropper.png">';
        };
