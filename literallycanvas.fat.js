...
(function() {
    ...
    LC.toolbarTemplate = '  <div class="toolbar-row">    <div class="toolbar-row-left">      <div class="color-square stroke-picker">&nbsp;</div>      <div class="tools" data-toggle="buttons-radio">        <div class="btn tool-pencil active">          <i class="icon-pencil"></i></div>        <div class="btn tool-eraser">          <i class="icon-edit"></i></div>        <div class="btn tool-pan">          <i class="icon-move"></i></div>        <div class="btn tool-eye-dropper">          <i class="icon-eye-open"></i></div>      </div>      <div class="tool-options-container">      </div>    </div>    <div class="toolbar-row-right">      <div class="action-buttons">        <div class="btn btn-danger clear-button">          <i class="icon-remove icon-white"></i>        </div>        <div class="btn btn-warning undo-button">          <i class="icon-arrow-left icon-white"></i>        </div>        <div class="btn btn-warning redo-button">          <i class="icon-arrow-right icon-white"></i>        </div>        <div class="btn btn-inverse zoom-out-button">          <i class="icon-zoom-out icon-white"></i>        </div>        <div class="zoom-display badge badge-inverse">1</div>        <div class="btn btn-inverse zoom-in-button">          <i class="icon-zoom-in icon-white"></i>        </div>      </div>    </div>    <div class="clearfix"></div>  </div>';
