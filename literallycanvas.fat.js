...
(function() {
    ...
    LC.LiterallyCanvas = function() {
        function LiterallyCanvas(canvas) {
            this.canvas = canvas;
...
(function() {
    ...
    LC.toolbarTemplate = '  <div class="toolbar-row">    <div class="toolbar-row-left">      <div class="color-pickers">        <div class="color-square stroke-picker">&nbsp;</div>      </div>      <div class="tools" data-toggle="buttons-radio">        <div class="btn tool-pencil active">          <i class="icon-pencil"></i></div>        <div class="btn tool-eraser">          <i class="icon-edit"></i></div>        <div class="btn tool-pan">          <i class="icon-move"></i></div>        <div class="btn tool-eye-dropper">          <i class="icon-eye-open"></i></div>      </div>    </div>    <div class="toolbar-row-right">      <div class="zoom-buttons">        <div class="btn btn-inverse zoom-out-button">          <i class="icon-zoom-out icon-white"></i>        </div>        <div class="zoom-display badge badge-inverse">1</div>        <div class="btn btn-inverse zoom-in-button">          <i class="icon-zoom-in icon-white"></i>        </div>      </div>    </div>    <div class="clearfix"></div>  </div>  <div class="toolbar-row">    <div class="toolbar-row-left">      <div class="tool-options-container">      </div>    </div>    <div class="toolbar-row-right">      <div class="action-buttons">        <div class="btn btn-danger clear-button">          <i class="icon-remove icon-white"></i>        </div>        <div class="btn btn-warning undo-button">          <i class="icon-arrow-left icon-white"></i>        </div>        <div class="btn btn-warning redo-button">          <i class="icon-arrow-right icon-white"></i>        </div>      </div>    </div>    <div class="clearfix"></div>  </div>';
    ...
    LC.Toolbar = function() {
        function Toolbar(lc, $el) {
            this.lc = lc;
            this.$el = $el;
            this.$el.append(_.template(LC.toolbarTemplate)());
            this.initColors();
            this.initButtons();
            this.initTools();
            this.initZoom();
        ...
        Toolbar.prototype.initTools = function() {
            var _this = this;
            this.tools = [ new LC.Pencil(), new LC.Eraser(), new LC.Pan(), new LC.EyeDropper() ];
            return _.each(this.tools, function(t) {
                ...
                return _this.$el.find(".tool-" + t.cssSuffix).click(function(e) {
...
(function() {
    ...
    LC.Tool = function() {
        function Tool() {}
        Tool.prototype.createOptions = function() {};
        ...
        Tool.prototype.createToolbar = function(el) {};
        Tool.prototype.removeToolbar = function(el) {};
        return Tool;
    }();
    LC.Pencil = function(_super) {
        ...
        Pencil.prototype.createOptions = function($el) {
            var brushWidthVal, _this = this;
            this.$el = $el;
            this.$el.html($('      <span class="brush-width-min">1 px</span>      <input type="range" min="1" max="50" step="1" value="5">      <span class="brush-width-max">50 px</span>      <span class="brush-width-val">(5 px)</span>    '));
            brushWidthVal = this.$el.find(".brush-width-val");
            return this.$el.find("input").change(function(e) {
